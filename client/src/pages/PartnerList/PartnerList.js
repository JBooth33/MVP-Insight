...
let id = 0;
function createData(companyID, companyName, address1, address2, city, state, zip, primaryContact,CompanyPhoneNumber, status, dateCreated) {
    id += 1;
    return { id, companyID, companyName, address1, address2, city, state, zip, primaryContact, CompanyPhoneNumber, status, dateCreated };
}
...
const columnData = [
    ...
    { id: 'primaryContact', numeric: true, disablePadding: false, label: 'Primary Contact' },
    { id: 'CompanyPhoneNumber', numeric: false, disablePadding: false, label: 'Company Phone Number' },
...
class EnhancedTable extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            selected: [],
            data: [
                createData(1,"MVP Logistics","10205 10th Ave N","","Plymouth","Minnesota", 55441,"Kimberly Maturo-Hilt",8883905320,"active"),
                createData(66529932,"Bain & Company, Inc.","131 Dartmouth Street","","Boston","Massachusetts", 2116,"Rebecca Owen",6175722000,"pending")
            ],
            page: 0,
            rowsPerPage: 5,
        };
                                ...
                                .map(n => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell string>{n.state}</TableCell>
                                            <TableCell string>{n.zip}</TableCell>
                                            <TableCell string>{n.primaryContact}</TableCell>
                                            <TableCell numeric>{n.CompanyPhoneNumber}</TableCell>
